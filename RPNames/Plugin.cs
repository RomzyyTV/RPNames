...
public class Plugin : Plugin<Config>
{
    ...
    public override string Author { get; } = "Babyboucher20 Maintained by Enes Batur";
    ...
    public override void OnEnabled()
    {
        ...
        Player.ChangingRole += Handler.OnPlayerChangeRole;
        Player.Died += Handler.OnPlayerDeath;
        base.OnEnabled();
    }
